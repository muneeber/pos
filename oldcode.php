<!-- The Old New Product Page -->
<div class="  justify-center  hidden">
        <form wire:submit.prevent="save" class="w-full max-w-lg shadow-md bg-white rounded p-4 my-6">
            @csrf
            ...
            <div class="mb-4 flex  bg-white flex-wrap justify-between">
                ...
                <div class="mb-4 w-full md:mb-0 md:w-1/3">
                    <label class="mb-2 block text-sm font-bold text-gray-700" for="retail_price"> Company </label>
                ...
                <div class="mb-4 w-full md:mb-0 md:w-1/3">
                    <label class="mb-2 block text-sm font-bold text-gray-700" for="sale_price"> Shelf </label>
