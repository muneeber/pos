<div class="m-2">
    ...
    <div class="sm:stats rounded-md sm:remove:flex sm:remove:flex-wrap sm:remove:gap-y-2 shadow w-full">

        <div class="stat border bg-white    hover:-translate-y-2 transition ease-in-out duration-300">
        ...
        <div class="stat border bg-white  hover:-translate-y-2 transition ease-in-out duration-300  ">
            ...
            <div class="stat-value text-green-500">{{ $ptm }} .Rs</div>
            {{-- <div class="stat-desc">21% more than last month</div> --}}
        </div>
        <div class="stat border bg-white  hover:-translate-y-2 transition ease-in-out duration-300 ">
