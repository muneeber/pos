                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input wire:model='name' type="text" name="name" id="name"
                                    ...
                                    placeholder="Type the Customer name" required="">
                                @error('name')
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="price"
                                    ...
                                    #</label>
                                <input wire:model='contact' type="number" name="price" id="price"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="03123456789" required="">
                                @error('contact')
                                    <p class="bg-red-600 text-white">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-2 sm:col-span-1">
                                <label for="id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Id Card
                                    #</label>
                                <input wire:model='idCard' type="number" name="price" id="id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Enter Customer's Id Card Number" required="">
                                @error('idCard')
                                    <p class="bg-red-600 text-white">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-2">
                                ...
                                <textarea id="description" wire:model='address' rows="3"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Write Customer's address here"></textarea>
                                @error('address')
                                    <p class="bg-red-600 text-white">{{ $message }}</p>
                                @enderror
                            </div>
